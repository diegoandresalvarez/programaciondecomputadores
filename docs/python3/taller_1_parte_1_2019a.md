...
### `13.py`
Calcule la suma de todos los múltiplos de 3 y de 5 que hay entre 101 y 1001. Tenga en cuenta que los números naturales entre 1 y 15 que son múltiplos de 3 y de 5 son 3, 5, 6 y 9, 12 y 15. La suma de dichos dígitos es 50. Adicionalmente, note que aunque 15 es múltiplo tanto de 3 como de 5 se suma una única vez.
